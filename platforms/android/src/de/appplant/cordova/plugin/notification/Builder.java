...
public class Builder {
    ...
    private void applyContentReceiver(NotificationCompat.Builder builder) {
       ...
       // if(Integer.parseInt(options.getIdStr())==1)
       // {
       //  builder.setFullScreenIntent(contentIntent, true);
       // }
        /* builder.setFullScreenIntent(contentIntent, true); 来电一样   无悬挂通知 nManager.notify(Integer.parseInt(options.getIdStr()), builder.build()); */
    }
